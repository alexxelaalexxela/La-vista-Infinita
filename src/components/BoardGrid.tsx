          ...
          <div className="text-center bg-white rounded-lg p-8 wood-shadow">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="ocean-gradient text-white">
                <a href="https://wa.me/50376717527?text=Hi%20Piry%27s%20Ding%20Repair!%20How%20much%20for%20box%20fixing,%20nose%20fixing,%20or%20sanded%20finish%3F">
            ...
            <div className="p-6">
              ...
              <div className="flex gap-4 mt-6">
                <Button 
                  ...
                  onClick={() => window.open(`https://wa.me/50376717527?text=${encodeURIComponent(`Hi Piry's Ding Repair! How much for ${selectedBoard.name}?`)}`, '_blank')}
                >
                  Request This Repair
                </Button>
